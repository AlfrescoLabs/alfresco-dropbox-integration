...
<body>
   <div>
      ...
      <#if success>
       <script>
		    window.location="/share/page/user/${user.id}/user-dropbox";
	   </script>
      <p style="font-size:150%">Link to Dropbox Account Complete.  Redirecting to User Profile</p>
      <br/>
      <p>If the page does not redirect soon, clink the link below</p>
      <#else>
      ...
      <br/>
      <a href="/share/page/user/${user.id}/user-dropbox">Return to your profile page</a>
      <br/>
      <br/>
      <br/>
