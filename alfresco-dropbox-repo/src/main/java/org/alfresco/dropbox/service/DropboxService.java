...
public class DropboxService
{
    ...
    private static Log               logger    = LogFactory.getLog(DropboxService.class);
    ...
    public OAuthToken getTokenFromUser(NodeRef person)
    {
    ...
    public void persistMetdata(Metadata metadata, NodeRef nodeRef)
    {
